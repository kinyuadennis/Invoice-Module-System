...
<div class="space-y-6">
    ...
    <div>
        ...
        <p class="mt-1 text-sm text-gray-600">Configure system-wide defaults and preferences</p>
    </div>
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="default_currency" id="default_currency" value="{{ old('default_currency', $settings['default_currency'] ?? 'KES') }}" maxlength="3" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="KES">
                    ...
                    <div>
                        ...
                        <select name="default_timezone" id="default_timezone" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="vat_rate" id="vat_rate" value="{{ old('vat_rate', $settings['vat_rate'] ?? 16.0) }}" step="0.01" min="0" max="100" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="invoice_prefix_default" class="block text-sm font-medium text-gray-700 mb-2">
                            Default Invoice Prefix
                        </label>
                        <input type="text" name="invoice_prefix_default" id="invoice_prefix_default" value="{{ old('invoice_prefix_default', $settings['invoice_prefix_default'] ?? 'INV') }}" maxlength="10" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        <label for="max_invoice_items" class="block text-sm font-medium text-gray-700 mb-2">
                            Max Invoice Items
                        </label>
                        <input type="number" name="max_invoice_items" id="max_invoice_items" value="{{ old('max_invoice_items', $settings['max_invoice_items'] ?? 100) }}" min="1" max="1000" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="flex items-center">
                            <input type="checkbox" name="enable_email_notifications" value="1" {{ old('enable_email_notifications', $settings['enable_email_notifications'] ?? true) ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        <label class="flex items-center">
                            <input type="checkbox" name="enable_sms_notifications" value="1" {{ old('enable_sms_notifications', $settings['enable_sms_notifications'] ?? false) ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
