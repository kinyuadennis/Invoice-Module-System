    ...
    <x-card>
        <form method="POST" action="{{ route('admin.clients.store') }}" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="address" id="address" rows="3" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ old('address') }}</textarea>
            </div>
