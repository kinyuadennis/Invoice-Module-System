...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">Manage testimonials and reviews</p>
        </div>
            ...
            <x-table>
                ...
                @foreach($reviews as $review)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-600">{{ Str::limit($review['title'], 50) }}</td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{{ $review['created_at']->format('M d, Y') }}</td>
