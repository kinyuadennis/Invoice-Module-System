<div class="py-12 bg-gray-50" id="invoicing-workflow">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Split Layout: Workflow Steps (Left) + Video Demo (Right) -->
        <div class="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-start">
            ...
            <div class="space-y-6">
                ...
                <div class="flex gap-4">
                    <div class="flex-shrink-0">
                        <div class="flex items-center justify-center h-10 w-10 rounded-full bg-blue-600 text-white font-bold text-sm">
                            1
                        </div>
                    </div>
                    <div>
            ...
            <!-- Right: Auto-Playing Workflow Demo -->
            <div class="mt-10 lg:mt-0 lg:sticky lg:top-24">
                <div
                    x-data="{
                        currentSlide: 0,
                        slides: [
                            '{{ asset('images/workflow/workflow_setup_screenshot_1766056031495.png') }}',
                            '{{ asset('images/workflow/workflow_create_screenshot_1766056049339.png') }}',
                            '{{ asset('images/workflow/workflow_send_screenshot_1766056067856.png') }}',
                            '{{ asset('images/workflow/workflow_send_screenshot_1766056067856.png') }}'
                        ],
                        autoplay: null,
                        init() {
                    ...
                    <div class="relative rounded-lg overflow-hidden shadow-xl bg-white" style="aspect-ratio: 16/10;">
                        <template x-for="(slide, index) in slides" :key="index">
                            <div
                                ...
                                <img :src="slide" alt="Workflow step" class="w-full h-full object-cover">
                            </div>
                        </template>
                    </div>
