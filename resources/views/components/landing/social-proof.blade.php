    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <p class="mt-3 text-xl text-gray-500 sm:mt-4">
                Join over 500+ Kenyan businesses who trust InvoiceHub for hassle-free invoicing.
            </p>
        </div>
    </div>
            ...
            <div class="bg-indigo-50 rounded-lg p-8">
                <div class="grid grid-cols-1 gap-8 md:grid-cols-3 text-center">
                    <div class="flex flex-col items-center">
                        ...
                        <h3 class="text-lg font-medium text-gray-900">KRA-eTIMS Certified</h3>
                        <p class="mt-2 text-sm text-gray-500">Invoices are automatically signed and submitted to Kenya Revenue Authority.</p>
                    </div>
                    <div class="flex flex-col items-center">
                        <div class="flex items-center justify-center h-12 w-12 rounded-full bg-indigo-100 text-indigo-600 mb-4">
                            <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <h3 class="text-lg font-medium text-gray-900">M-PESA Ready</h3>
                        <p class="mt-2 text-sm text-gray-500">Receive payments instantly via Safaricom’s Lipa na M-PESA.</p>
                    </div>
                    <div class="flex flex-col items-center">
                        <div class="flex items-center justify-center h-12 w-12 rounded-full bg-indigo-100 text-indigo-600 mb-4">
                            <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <p class="mt-2 text-sm text-gray-500">Local help to keep you running, day and night.</p>
                    </div>
                </div>
            </div>
        </div>
