...
<section id="pricing" class="bg-gray-50 dark:bg-gray-900 py-16 lg:py-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div x-data="{ cycle: 'monthly' }" class="max-w-7xl mx-auto">
            ...
            <div class="flex justify-center mb-12">
                <div class="inline-flex rounded-lg bg-white dark:bg-gray-800 p-1 shadow-sm border border-gray-200 dark:border-gray-700">
                    <button
                        @click="cycle = 'monthly'"
                        :class="cycle === 'monthly' ? 'bg-[#2B6EF6] text-white' : 'text-gray-700 dark:text-gray-300'"
                    ...
                    <button
                        @click="cycle = 'yearly'"
                        :class="cycle === 'yearly' ? 'bg-[#2B6EF6] text-white' : 'text-gray-700 dark:text-gray-300'"
                        class="px-6 py-2 rounded-md text-sm font-medium transition-colors duration-150"
                    >
                        Yearly
            ...
            @foreach($plans as $plan)
                ...
                <div 
                    class="relative bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 {{ $isPopular ? 'border-[#2B6EF6] scale-105 ring-4 ring-blue-100 dark:ring-blue-900/20' : 'border-gray-200 dark:border-gray-700' }}"
                    x-show="true"
                >
                    @if($isPopular)
        ...
        <!-- Trust Badges -->
        <div class="mt-12 flex flex-wrap items-center justify-center gap-6 text-sm text-gray-600 dark:text-gray-400">
