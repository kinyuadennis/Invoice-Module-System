...
<div class="space-y-6" x-data="recurringInvoiceForm()">
    <div>
        ...
        <p class="mt-1 text-sm text-gray-600">Set up automated recurring invoices for regular clients</p>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <a href="{{ route('user.recurring-invoices.index') }}" class="w-full px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 text-center">
                        Cancel
                    </a>
                </div>
            </div>
