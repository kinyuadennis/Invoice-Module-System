...
<div class="space-y-6 mb-6">
    ...
    <form method="POST" action="{{ route('user.companies.store') }}" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <x-select
                                    ...
                                    value="{{ old('timezone', 'Africa/Nairobi') }}"
                                    required
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            <x-select
                                ...
                                value="{{ old('default_invoice_template_id') }}"
                            />
                        </div>
                    </div>
                </x-card>
        ...
        <div class="flex items-center justify-end space-x-3 mt-6">
            ...
            <x-button type="submit" variant="primary">Create Company</x-button>
        </div>
    </form>
</div>
@endsection
