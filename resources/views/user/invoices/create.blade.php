...
<div class="space-y-6" x-data="invoiceForm()">
    <div>
        ...
        <p class="mt-1 text-sm text-gray-600">Fill out the details below to create a new invoice</p>
    </div>

    <form method="POST" action="{{ route('user.invoices.store') }}" @submit.prevent="submitForm">
        @csrf
