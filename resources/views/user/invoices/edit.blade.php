...
<div class="space-y-6" x-data="invoiceForm()">
    ...
    <form method="POST" action="{{ route('user.invoices.update', $invoice['id'] ?? 0) }}" @submit.prevent="submitForm">
        @csrf
        @method('PUT')
        ...
        <x-card>
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <x-select 
                    ...
                    :value="old('status', $invoice['status'] ?? 'draft')"
                />
            </div>
        </x-card>
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <x-card>
                ...
                <div class="mt-6">
                    <x-button type="submit" variant="primary" class="w-full">Update Invoice</x-button>
                </div>
            </x-card>
        </div>
    </form>
