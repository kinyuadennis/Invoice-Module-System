...
<div class="space-y-6">
    <div>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">Select the invoice to create a credit note for</p>
    </div>
                        ...
                        <a href="{{ route('user.credit-notes.create', ['invoice_id' => $invoice->id]) }}" class="block p-4 border border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-300">{{ $invoice->client->name ?? 'N/A' }}</p>
