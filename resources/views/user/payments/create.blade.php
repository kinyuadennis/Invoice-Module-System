...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">Record a manual payment for an invoice</p>
        </div>
        ...
        <form method="POST" action="{{ route('user.invoices.record-payment', ['id' => request('invoice_id', 0)]) }}" id="payment-form">
            ...
            <div class="space-y-6">
                ...
                <div x-data="{ 
                    ...
                    <label for="invoice_id" class="block text-sm font-medium text-gray-700">Select Invoice (Sent or Partial)</label>
