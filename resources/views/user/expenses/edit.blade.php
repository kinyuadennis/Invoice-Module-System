            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div>
                    <x-select 
                        ...
                        value="{{ old('category_id', $expense['category']['id'] ?? '') }}"
                    />
                </div>
                ...
                <div>
                    <x-select 
                        ...
                        value="{{ old('client_id', $expense['client']['id'] ?? '') }}"
                    />
                </div>
                ...
                <div>
                    <x-select 
                        ...
                        value="{{ old('status', $expense['status'] ?? 'pending') }}"
                    />
                </div>
                ...
                <div class="sm:col-span-2">
                    ...
                    @if(isset($expense['receipt_path']) && $expense['receipt_path'])
                        <div class="mb-2">
                            <a href="{{ Storage::url($expense['receipt_path']) }}" target="_blank" class="text-sm text-blue-600 hover:text-blue-800">
                    ...
                    >
                    <p class="mt-1 text-xs text-gray-500">Upload new receipt to replace existing (max 10MB)</p>
                </div>
