...
<div class="space-y-6">
    <div>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">Create a new role and assign permissions</p>
    </div>
    ...
    <form method="POST" action="{{ route('user.roles.store') }}" class="space-y-6">
        ...
        <div class="flex items-center justify-end space-x-3">
            <a href="{{ route('user.roles.index') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 dark:text-gray-200 hover:bg-gray-50">
                Cancel
            </a>
