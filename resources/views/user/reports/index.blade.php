...
<div class="space-y-6">
    <div>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">View detailed reports and export data</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <x-card>
            ...
            <p class="text-sm text-gray-600 dark:text-gray-300 mb-4">View revenue trends, top clients, and monthly breakdowns</p>
        ...
        <x-card>
            ...
            <p class="text-sm text-gray-600 dark:text-gray-300 mb-4">Analyze invoices by status, client, and date range</p>
        ...
        <x-card>
            ...
            <p class="text-sm text-gray-600 dark:text-gray-300 mb-4">Track payments, methods, and payment trends</p>
        ...
        <x-card>
            ...
            <p class="text-sm text-gray-600 dark:text-gray-300 mb-4">Track outstanding invoices grouped by age (0-30, 31-60, 61-90, 90+ days)</p>
        ...
        <x-card>
            ...
            <p class="text-sm text-gray-600 dark:text-gray-300 mb-4">View revenue, expenses, and profit/loss analysis</p>
        ...
        <x-card>
            ...
            <p class="text-sm text-gray-600 dark:text-gray-300 mb-4">Analyze expenses by category, payment method, and trends</p>
