...
<!-- HERO SECTION -->
<x-hero.hero-split
    title="{{ $heroHeading ?? 'Get paid faster with professional invoices — KRA compliant, M-Pesa ready, trusted by 500+ Kenyan businesses.' }}"
    subtitle="Create, send, and track invoices in minutes. Automatic VAT calculations, payment reminders, and full KRA eTIMS compliance. No credit card required."
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div class="text-center">
                ...
                <h3 class="font-bold text-slate-900 text-sm mb-1">60 Seconds</h3>
                <p class="text-xs text-slate-600">Create invoice</p>
            </div>
            <div class="text-center">
                ...
                <h3 class="font-bold text-slate-900 text-sm mb-1">M-Pesa Ready</h3>
                <p class="text-xs text-slate-600">Accept payments</p>
            </div>
            <div class="text-center">
                ...
                <h3 class="font-bold text-slate-900 text-sm mb-1">KRA Compliant</h3>
                <p class="text-xs text-slate-600">eTIMS ready</p>
            </div>
            <div class="text-center">
                ...
                <h3 class="font-bold text-slate-900 text-sm mb-1">Real-time Insights</h3>
                <p class="text-xs text-slate-600">Track everything</p>
            </div>
        </div>
    </div>
</section>
