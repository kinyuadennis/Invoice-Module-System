/**
 * Demo Manager - Handles the interactive demo walkthrough
 * Simple, direct approach without Shepherd.js complexity
 */
...
// Export current step for UI updates
        ...
        <div class="text-center py-8">
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-500">
                    This demo will show you the complete workflow from signup to getting paid in just 6 steps.
                </p>
            </div>
            ${getStepIndicator(0)}
        </div>
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-6 shadow-sm" id="preview-demo">
                <div class="border-2 border-dashed border-gray-300 rounded-lg p-8 bg-gray-50 min-h-[300px] flex flex-col items-center justify-center mb-4">
                    <div class="text-center mb-6">
                        ...
                        <p class="text-sm font-semibold text-blue-600 mt-4 text-xl">KES 65,000</p>
                    </div>
                </div>
    ...
    return `
        <div class="max-w-md mx-auto">
            ...
            <div class="bg-gradient-to-br from-green-50 to-blue-50 border-2 border-green-200 rounded-lg p-8 text-center" id="payment-demo">
                ...
                <a href="/register" class="inline-block w-full bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 font-medium transition-colors text-center">
    ...
    return `
        <div class="mt-6">
            <div class="grid grid-cols-5 gap-2 max-w-md mx-auto">
                ${[0, 1, 2, 3, 4].map(i => `
                    <div class="h-2 rounded ${i <= step ? 'bg-blue-600' : 'bg-gray-200'}"></div>
                `).join('')}
            </div>
            <p class="text-sm text-gray-500 mt-2 text-center">Step ${step + 1} of ${totalSteps}</p>
        </div>
    `;
}
...
function updateStepIndicator() {
    // Indicator is already in the content, no need to update separately
}
...
export function nextStep() {
    if (currentStep < totalSteps - 1) {
        ...
        window.dispatchEvent(new CustomEvent('demo-step-changed', { detail: { step: currentStep } }));
    }
}
